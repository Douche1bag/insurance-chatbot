...
class RAGService {
  ...
  isAmountOrPremiumQuery(query) {
    ...
    // ❌ อย่าใส่ "ผลประโยชน์","ค่าชดเชย","สินไหม","เสียชีวิต" — คำเหล่านี้คือคำถามทั่วไป ไม่ใช่ amount query
    const keywords = [
